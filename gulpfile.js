...
gulp.task( 'translate', function () {   
     return gulp.src( './**/*.php')
       ...
       .pipe(wpPot( {
           domain        : 'nuptial',
           destFile      : 'nuptial.pot',
           package       : 'Nuptial'
       } ))
      .pipe(gulp.dest('languages/nuptial.pot'))
});  
...
gulp.task('clean', function() {
  return del(['images','languages/nuptial.pot','rtl.css']);      
}); 
...
gulp.task('watch',function(){  
  browserSync.init({  
    files: ['./**/*.php'],    
    proxy: 'http://localhost/new/nuptial',
  }); 
